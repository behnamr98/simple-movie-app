...
final class MoviesSceneDIContainer {
    ...
    struct Dependencies {
        let apiDataTransferService: WebService
    }
    ...
    func makeFetchMoviesRepository() -> FetchMovieRepository {
        return DefaultFetchMovieRepository(service: dependencies.apiDataTransferService)
    }
    
    
    // MARK: - Movies List View Controller
    
    
    
    
    // MARK: - Movies Details View Controller
