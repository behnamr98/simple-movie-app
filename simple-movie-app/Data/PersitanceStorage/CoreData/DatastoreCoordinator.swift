...
class DatastoreCoordinator: NSObject {
    ...
    fileprivate let objectModelName = "simple_movie_app"
    fileprivate let objectModelExtension = "momd"
    fileprivate let dbFilename = "simple_movie_app.sqlite"
    fileprivate let appDomain = "ios.behnamr98.simple-movie-app"
    ...
    func getUrl() -> String  {
        return persistentStoreCoordinator.persistentStores.first?.url?.absoluteString ?? ""
    }
